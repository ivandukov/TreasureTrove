...
/**
 * renders a button to the social media profile of 
 * this web app (Twitter, Youtube, Instagram)
 * @param param0 
 * @returns 
 */
...
/**
 * renders a "heading" for the list of hrefs in the footer
 * @param param0 
 * @returns a simple Text functioning as a "heading"
 */
...
/**
 * renders a footer with buttons, hrefs and an input
 * field for a newsletter 
