                ...
                <SimpleGrid columns={{ base: 1, sm: 1, md: 1 }} spacing={6}>
                    {Array.from({ length: 1 }, (_, index) => (
                        <GiveawayCard
                            ...
                            imgUrl={
                                "https://media.istockphoto.com/id/95757561/de/foto/auto-rad.jpg?s=612x612&w=0&k=20&c=_8Dq1DP01hW0Wq2BnwqhnKJNwpnv_D0tvVWFCvZ0TaQ="
                            }
                            key={index}
                        />
                    ))}
                ...
                <SimpleGrid columns={{ base: 1, sm: 1, md: 1 }} spacing={6}>
                    {Array.from({ length: 1 }, (_, index) => (
                        <GiveawayCard
                            ...
                            location="Darmstadt"
                            imgUrl={
                                "https://images.unsplash.com/photo-1591462392051-d3668711d52d?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHN1cGVyJTIwbmludGVuZG98ZW58MHx8MHx8fDA%3D"
                            }
                            key={index}
                        />
                    ))}
